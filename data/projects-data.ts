export const projectsData = [
    {
        id: 1,
        name: 'Hypno Switch – Digital Hypnotherapy Platform',
    ...
    {
        id: 2,
        name: 'FoodSecure – Food Donation Management System',
    ...
    {
        id: 4,
        name: 'E-commerce Desktop Application',
        description: "Created a feature-rich desktop e-commerce application with product management, cart functionality, and order processing. Implemented MySQL database for inventory management and built Java GUI for intuitive user interface. Designed for local retail businesses to manage their operations efficiently.",
        tools: ['Java', 'MySQL', 'Java Swing', 'JDBC'],
