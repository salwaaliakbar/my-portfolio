...
function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="from-[#0D1B2A] border-[#415A77] relative rounded-lg border bg-linear-to-r to-[#1B263B] w-full shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:shadow-[0_0_30px_rgba(6,182,212,0.3)] transition-all duration-300">
