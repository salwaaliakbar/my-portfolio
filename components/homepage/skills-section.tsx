...
function Skills() {
  ...
  const expertiseData: ExpertiseData[] = [
    ...
    },
    {
      ...
      description: "Data Structures, OOP, Operating Systems & Database Systems",
      avgProficiency: 90,
      topSkills: [
        { name: "Data Structures & Algorithms", level: "Expert", proficiency: 90 },
        { name: "Object-Oriented Programming", level: "Expert", proficiency: 95 },
        { name: "Operating Systems", level: "Advanced", proficiency: 85 },
        { name: "Database Management Systems", level: "Expert", proficiency: 90 },
      ],
